...
| Alert aggregation | `correlation/aggregation.py` | 5 detections from same process tree → 1 investigation thread | 4/5 | In Progress|  | Event drilldown returns full correlation context |

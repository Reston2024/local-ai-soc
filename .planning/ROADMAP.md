...
| JSON/NDJSON/CSV parsers | `ingestion/parsers/json_ndjson.py`, `ingestion/parsers/csv_parser.py` | 3 fixture files ingest correctly |
| DuckDB loader | `ingestion/loader.py` | Deduplication on re-ingest tested |
